...
def create_refinement_section(translator: Translator) -> Dict[str, Any]:
    ...
    with gr.Group():
        ...
        with gr.Row():
            with gr.Column():
                ...
                """
                gr.Markdown(
                    "EXPERIMENTAL FEATURE - It seems like camera extrinsics made this obsolete - and even in my best case ",
                    "scenarios it makes my animations worse.",
    ...
    # Wire up load file
    load_outputs = [refinement_enabled, interpolate_missing_keyframes] + save_inputs[2:]
    ...
    def build_refinement_config_wrapper(*args):
        ...
        (enabled, interpolate_missing_keyframes,
         ...
         arms_method, arms_cutoff_hz, arms_one_euro_min_cutoff, arms_one_euro_beta, arms_one_euro_d_cutoff,
         default_max_pos_speed, default_max_pos_accel, default_max_ang_speed_deg, default_max_ang_accel_deg,
         default_method, default_cutoff_hz, default_one_euro_min_cutoff, default_one_euro_beta, default_one_euro_d_cutoff) = args
